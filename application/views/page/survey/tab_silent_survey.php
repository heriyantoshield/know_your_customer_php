                    ...
                    <div class="col-sm-9">
                        <div class="input-group">
                            ...
                            <div class="col-sm-2" style="margin-left: 25px;">
                                <input class="form-check-input" type="checkbox" id="lokasirumah" value="RUMAH">
                                <label class="form-check-label">
                                    Rumah
                                </label>
                            </div>
                            <div class="col-sm-2">
                                <input class="form-check-input" type="checkbox" id="lokasiusaha" value="TEMPAT USAHA">
                                <label class="form-check-label">
                                    Tempat Usaha
                                </label>
                        ...
                        <div class="input-group">
                            ...
                            <div class="col-sm-8">
                                <div class="form-check" style="margin-left:5px;">
                                    <input class="form-check-input" type="radio" name="radiorumahtempatusaha" id="radiofotorumah" value="01">
                                    <label class="form-check-label">
                                        Foto Rumah
                                    </label>
                                </div>
                                <div class="form-check" style="margin-left:5px;">
                                    <input class="form-check-input" type="radio" name="radiorumahtempatusaha" id="radiofotousaha" value="02">
                                    <label class="form-check-label">
                                        Foto Tempat Usaha
                                    </label>
                                </div>
                                <div class="form-check" style="margin-left:5px;">
                                    <input class="form-check-input" type="radio" name="radiorumahtempatusaha" id="radiofotorumahusaha" value="03">
                                    <label class="form-check-label">
                                ...
                                <div class="form-group row" style="margin-top:25px;" id="addformrumah" hidden>
                                    <div class="col-sm-12">
                                        <div class="form-check" style="margin-left:5px;">
                                            <input class="form-check-input" type="radio" name="radiorumahtempatusaha1" id="radiofotorumah1" value="01">
                                            <label class="form-check-label">
                                                Foto Rumah
                                            </label>
                                        </div>
                                        <div class="form-check" style="margin-left:5px;">
                                            <input class="form-check-input" type="radio" name="radiorumahtempatusaha1" id="radiofotousaha1" value="02">
                                            <label class="form-check-label">
                                                Foto Tempat Usaha
                                            </label>
                                        </div>
                                        <div class="form-check" style="margin-left:5px;">
                                            <input class="form-check-input" type="radio" name="radiorumahtempatusaha1" id="radiofotorumahusaha1" value="03">
                                            <label class="form-check-label">
                                                Foto Rumah & Tempat Usaha
                                            </label>
                                        </div>
                ...
                <div class="col-sm-12">
                    <div class="col-sm-9">
                        <div class="input-group">
                            ...
                            <div class="col-sm-8">
                                <div class="form-check" style="margin-left:5px;">
                                    <input class="form-check-input" type="radio" name="radiojalan" id="radiojalanrumah" value="01">
                                    <label class="form-check-label" for="flexRadioDefault1">
                                        Foto Jalan Depan Rumah
                                    </label>
                                </div>
                                <div class="form-check" style="margin-left:5px;">
                                    <input class="form-check-input" type="radio" name="radiojalan" id="radiojalanusaha" value="02">
                                    <label class="form-check-label">
                                        Foto Jalan Depan Tempat Usaha
                                    </label>
                                </div>
                                <div class="form-check" style="margin-left:5px;">
                                    <input class="form-check-input" type="radio" name="radiojalan" id="radiojalanrumahusaha" value="03">
                                    <label class="form-check-label">
                                ...
                                <div class="form-group row" style="margin-top:25px;" id="addformjalan" hidden>
                                    <div class="col-sm-12">
                                        <div class="form-check" style="margin-left:5px;">
                                            <input class="form-check-input" type="radio" name="radiojalan1" id="radiojalanrumah1" value="01">
                                            <label class="form-check-label">
                                                Foto Jalan Depan Rumah
                                            </label>
                                        </div>
                                        <div class="form-check" style="margin-left:5px;">
                                            <input class="form-check-input" type="radio" name="radiojalan1" id="radiojalanusaha1" value="02">
                                            <label class="form-check-label">
                                                Foto Jalan Depan Tempat Usaha
                                            </label>
                                        </div>
                                        <div class="form-check" style="margin-left:5px;">
                                            <input class="form-check-input" type="radio" name="radiojalan1" id="radiojalanrumahusaha1" value="03">
                                            <label class="form-check-label">
                                                Foto Jalan Depan Rumah & Tempat Usaha
                                            </label>
                                        </div>
            ...
            <div class="form-group row" style="margin-top:25px;">
                <div class="col-sm-12">
                    <div class="col-sm-9">
                        <div class="input-group">
                            <div class="col-sm-4">
                                <label>Alamat Informan 1<span style="color:red">*</span></label>
                            </div>
                            <div class="col-sm-4">
                                <input type="input" class="form-control" id="alamatinforman">
                                <label class="error-alamatinforman error-info" id="err-alamatinforman" hidden></label>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-sm-8">
                         <div class="input-group">
                            <div class="col-sm-2" style="margin-left: 10px;">
                                <input class="form-check-input" type="radio" name="radiodebt" id="radiodebtiya" value="01">
                                <label class="form-check-label">
                                    Ya
                                </label>
                            </div>
                            <div class="col-sm-2">
                                <input class="form-check-input" type="radio" name="radiodebt" id="radiodebttidak" value="02">
                                <label class="form-check-label">
                                    Tidak
                                </label>
                            </div>
                ...
                <div class="col-sm-12">
                    <div class="col-sm-9">
                        ...
                        <div class="col-sm-8">
                            <div class="input-group">
                                <div class="col-sm-2" style="margin-left: 10px;">
                                    <input class="form-check-input" type="radio" name="radiososial" id="radiososialiya" value="01">
                                    <label class="form-check-label" for="flexRadioDefault1">
                                        Ya
                                    </label>
                                </div>
                                <div class="col-sm-2">
                                    <input class="form-check-input" type="radio" name="radiososial" id="radiososialtidak" value="02">
                                    <label class="form-check-label">
                                        Tidak
                                    </label>
                                </div><br>
                ...
                <div class="col-sm-12">
                    <div class="col-sm-9">
                        ...
                        <div class="col-sm-8">
                            <div class="input-group">
                                <div class="col-sm-2" style="margin-left: 10px;">
                                    <input class="form-check-input" type="radio" name="radiolsm" id="radiolsmiya" value="01">
                                    <label class="form-check-label" for="flexRadioDefault1">
                                        Ya
                                    </label>
                                </div>
                                <div class="col-sm-2">
                                    <input class="form-check-input" type="radio" name="radiolsm" id="radiolsmtidak" value="02">
                                    <label class="form-check-label">
                                        Tidak
                                    </label>
                                </div><br>
                ...
                <div class="col-sm-12">
                    <div class="col-sm-9">
                        ...
                        <div class="col-sm-8">
                            <div class="input-group">
                                <div class="col-sm-2" style="margin-left: 10px;">
                                    <input class="form-check-input" type="radio" name="radiostatus" id="radiokepemilikansesuai" value="01">
                                    <label class="form-check-label">
                                        Sesuai
                                    </label>
                                </div>
                                <div class="col-sm-4">
                                    <input class="form-check-input" type="radio" name="radiostatus" id="radiokepemilikantidaksesuai" value="02">
                                    <label class="form-check-label">
                                        Tidak Sesuai
                                    </label>
                                </div>
                    ...
                    <div class="col-sm-9">
                        <div class="col-sm-4">
                            ...
                            <div class="input-group col-sm-10">
                                ...
                                <div class="input-group">
                                <div class="col-sm-2" style="margin-left: 10px;">
                                    <input class="form-check-input" type="radio" name="radiotinggaltidaksesuai" id="radiotinggalsesuai" value="01">
                                    <label class="form-check-label">
                                        Sesuai
                                    </label>
                                </div>
                                <div class="col-sm-3">
                                    <input class="form-check-input" type="radio" name="radiotinggaltidaksesuai" id="radiotinggaltidaksesuai" value="02">
                                    <label class="form-check-label">
                                        Tidak Sesuai
                                    </label>
                                </div>
